...
public:
  ...
  */
  ...
  virtual void drawRect(int16_t x, int16_t y, int16_t w, int16_t h,
                        uint16_t color);
  virtual void interpolateHLine(int16_t x, int16_t y, uint16_t w, uint16_t color1, uint16_t color2);
  virtual void interpolateFastHLine(int16_t x, int16_t y, uint16_t w, uint16_t color1, uint16_t color2);
  ...
  void fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2,
                    int16_t y2, uint16_t color);
  void shadeTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                    int16_t x2, int16_t y2, uint16_t color0, uint16_t color1, uint16_t color2);
  uint16_t interpolate565(uint16_t color0, uint16_t color1, uint8_t alpha);
  uint16_t interpolate8(uint8_t color0, uint8_t color1, uint8_t alpha);
